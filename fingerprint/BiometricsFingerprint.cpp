...
public:
    ...
    Return<void> onAcquired(uint64_t deviceId, vendor::oplus::hardware::biometrics::fingerprint::V2_1::FingerprintAcquiredInfo acquiredInfo,
        int32_t vendorCode) {
        return mClientCallback->onAcquired(deviceId, OplusTolineageFingerprintAcquiredInfo(acquiredInfo), vendorCode);
    }
    ...
    Return<void> onError(uint64_t deviceId, vendor::oplus::hardware::biometrics::fingerprint::V2_1::FingerprintError error, int32_t vendorCode) {
        return mClientCallback->onError(deviceId, OplusTolineageFingerprintError(error), vendorCode);
    }
...
private:
    ...
    Return<android::hardware::biometrics::fingerprint::V2_1::FingerprintAcquiredInfo> OplusTolineageFingerprintAcquiredInfo(vendor::oplus::hardware::biometrics::fingerprint::V2_1::FingerprintAcquiredInfo info) {
        switch(info) {
    ...
    Return<android::hardware::biometrics::fingerprint::V2_1::FingerprintError> OplusTolineageFingerprintError(vendor::oplus::hardware::biometrics::fingerprint::V2_1::FingerprintError error) {
        switch(error) {
...
Return<RequestStatus> BiometricsFingerprint::OplusTolineageRequestStatus(vendor::oplus::hardware::biometrics::fingerprint::V2_1::RequestStatus req) {
    switch(req) {
...
Return<RequestStatus> BiometricsFingerprint::enroll(const hidl_array<uint8_t, 69>& hat,
    ...
    return OplusTolineageRequestStatus(mOplusBiometricsFingerprint->enroll(hat, gid, timeoutSec));
}

Return<RequestStatus> BiometricsFingerprint::postEnroll()  {
    return OplusTolineageRequestStatus(mOplusBiometricsFingerprint->postEnroll());
}
...
Return<RequestStatus> BiometricsFingerprint::cancel()  {
    RequestStatus ret = OplusTolineageRequestStatus(mOplusBiometricsFingerprint->cancel());
...
Return<RequestStatus> BiometricsFingerprint::enumerate()  {
    return OplusTolineageRequestStatus(mOplusBiometricsFingerprint->enumerate());
}

Return<RequestStatus> BiometricsFingerprint::remove(uint32_t gid, uint32_t fid)  {
    return OplusTolineageRequestStatus(mOplusBiometricsFingerprint->remove(gid, fid));
}

Return<RequestStatus> BiometricsFingerprint::setActiveGroup(uint32_t gid,
    const hidl_string& storePath)  {
    return OplusTolineageRequestStatus(mOplusBiometricsFingerprint->setActiveGroup(gid, storePath));
}

Return<RequestStatus> BiometricsFingerprint::authenticate(uint64_t operationId, uint32_t gid)  {
    return OplusTolineageRequestStatus(mOplusBiometricsFingerprint->authenticate(operationId, gid));
}
